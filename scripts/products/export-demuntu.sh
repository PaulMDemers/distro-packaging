...
usage() {
  cat >&2 <<'EOF'
Usage: export-demuntu.sh [TARGET_REPO]

Export Demuntu-owned files from the packaging workspace into a Demuntu product
repo checkout. TARGET_REPO defaults to ../Demuntu.
EOF
}
...
copy_glob "assets/boot/demuntu-*" "assets/boot"
copy_path "configs/ubuntu"
